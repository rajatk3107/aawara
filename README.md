...
- **1RM calculator** — estimate your one-rep max from any weight × reps (Epley), with a rep/percentage table (target weights for 2/3/5/8/10/12 reps); reachable from the Progress screen and the home Quick Access grid
- Progress photos — timeline of physique photos with add (camera/gallery, crop, note), zoomable detail, and side-by-side before/after comparison with share
...
| 1.12 | Standalone **1RM calculator** — Epley estimate from weight × reps plus a rep/percentage table (2/3/5/8/10/12 reps), reachable from the Progress screen and home Quick Access grid; calculation logic unit-tested |
